# [Model-View-ViewModel (ie MVVM)](https://github.com/navdeepera04/Android-MVVM-architecture)
...
You can also check [**MVP**](https://github.com/navdeepera04/Android-MVP-Architecture)

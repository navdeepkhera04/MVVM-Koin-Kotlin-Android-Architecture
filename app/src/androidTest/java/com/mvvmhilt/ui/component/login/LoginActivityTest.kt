...
class LoginActivityTest {
    ...
    fun testLoginSuccess() {
        ...
        onView(withId(R.id.username)).perform(typeText("navdeepkhera04@gmail.com"))
        onView(withId(R.id.password)).perform(typeText("navdeepKhera"))
        onView(withId(R.id.login)).perform(click())
        Intents.intended(hasComponent(hasClassName("com.mvvmhilt.ui.component.recipes.RecipesListActivity")))
    }
